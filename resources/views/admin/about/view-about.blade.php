...
@section('title', 'Ahmadportopolio - View About')
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-body text-center">
                                    {{-- @if ($about->image)
                                        <img src="{{ asset('public-assets/images/') }}" alt="admin avatar"
                                            class="img-fluid mt-5" style="height: 400px">
                                    @else --}}
                                    ...
                                    <p class="text-muted my-2">Admin, Ahmad,Portfolio</p>
